  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Background Slides (Full screen background photo layout) */}
        <div className="w-full absolute inset-0 h-full z-10 overflow-hidden">
          {/* Slides layered with OPACITY cross-fade (storefront remains static) */}
          {slides.map((slide, idx) => {
            ...
            return (
              ...
              >
                {/* Background Image with slow Ken Burns effect, scaled auto 100% and aligned right on desktop */}
                <div 
